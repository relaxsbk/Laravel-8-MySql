    ...
    <section class="container d-flex flex-column align-items-center">
        <form class="w-50" method="post">
            ...
            <div class="mb-3">
                ...
                <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="test@test.ru">
            </div>
            ...
            <div class="mb-3">
                ...
                <input name="repeat_password" type="password" class="form-control" id="InputPassword_conf">
            </div>
